"""
Django settings for spring_disk_42388 project.
...
ROOT_URLCONF = 'spring_disk_42388.urls'
...
WSGI_APPLICATION = 'spring_disk_42388.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "spring_disk_42388 API",
    "DESCRIPTION": "API documentation for spring_disk_42388 App",
    "VERSION": "v1",
}
